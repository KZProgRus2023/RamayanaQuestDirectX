#include "pch.h"
#include "RamayanaQuestDirectXMain.h"
#include "Common\DirectXHelper.h"

using namespace RamayanaQuestDirectX;
using namespace Windows::Foundation;
using namespace Windows::System::Threading;
using namespace Concurrency;

// Загружает и инициализирует ресурсы приложения во время его загрузки.
RamayanaQuestDirectXMain::RamayanaQuestDirectXMain(const std::shared_ptr<DX::DeviceResources>& deviceResources) :
...
RamayanaQuestDirectXMain::~RamayanaQuestDirectXMain()
{
...
void RamayanaQuestDirectXMain::CreateWindowSizeDependentResources() 
{
...
void RamayanaQuestDirectXMain::Update() 
{
...
bool RamayanaQuestDirectXMain::Render() 
{
...
void RamayanaQuestDirectXMain::OnDeviceLost()
{
...
void RamayanaQuestDirectXMain::OnDeviceRestored()
{
